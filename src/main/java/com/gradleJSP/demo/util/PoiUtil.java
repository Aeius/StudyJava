...
public class PoiUtil {
    ...
    public static void createXls(List<People> list, long rowCount, long colCount){
        // 엑셀 시트 생성
    ...
    public static void createXslx (List<People> list, long rowCount, long colCount) {
        //Blank workbook
        ...
        // 엑셀 파일 생성
        try {
            File xlsxFile = new File("C:/workspace/gradleJSP/src/main/java/com/gradleJSP/demo/output/people.xlsx");
            FileOutputStream fos = new FileOutputStream(xlsxFile);
            workbook.write(fos);
